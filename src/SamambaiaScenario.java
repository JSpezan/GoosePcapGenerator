...
import br.ufu.facom.ereno.dataExtractors.PcapWriter;
...
//        uc08.setInitialTimestamp(mu.getInitialTimestamp());
    ...
    public void exportDataset() {
        ...
        //Teste para geracao do pcap
        boolean generate_pcap = true;

        try {
            if (!debug) {
                if (generate_arff) {

                    //"E:\\ereno dataset\\ereninho\\multiclass_train.arff"
                    ARFFWritter.startWriting("multiclass_train.arff");
                    ...
                    CSVWritter.startWriting("dataset.csv");//"E:\\ereno dataset\\ereninho\\dataset.csv");
                ...
                if (generate_pcap) {
                    String pcapPath = System.getProperty("user.dir") + File.separator + "output" + File.separator + "dataset.pcap";
                    PcapWriter.processDataset(substationNetwork.stationBusMessages, substationNetwork.processBusMessages, pcapPath);
                }


                //String filePath = System.getProperty("user.dir") + File.separator + "output" + File.separator + fileName;
            } else {
